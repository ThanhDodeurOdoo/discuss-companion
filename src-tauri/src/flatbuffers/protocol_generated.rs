    ...
    pub mod flatbuffers {
        ...
        impl<'a> KeyBinding<'a> {
            ...
            >(
                ...
                if let Some(x) = args.modifiers {
                    builder.add_modifiers(x);
                }
        ...
        impl ::flatbuffers::Verifiable for KeyBinding<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>("modifiers", Self::VT_MODIFIERS, false)?
                    .finish();
                Ok(())
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KeyBindingBuilder<'a, 'b, A> {
            ...
            pub fn add_modifiers(
                &mut self,
                modifiers: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<&'b str>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    KeyBinding::VT_MODIFIERS,
                    modifiers,
                );
            }
            #[inline]
        ...
        impl<'a> PttDown<'a> {
            ...
            pub fn key(&self) -> Option<KeyBinding<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<KeyBinding>>(PttDown::VT_KEY, None)
                }
            }
            #[inline]
            pub fn is_repeat(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(PttDown::VT_IS_REPEAT, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for PttDown<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<KeyBinding>>(
                        "key",
                        Self::VT_KEY,
                        false,
                    )?
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PttDownBuilder<'a, 'b, A> {
            ...
            pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<KeyBinding<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<KeyBinding>>(PttDown::VT_KEY, key);
            }
            #[inline]
            pub fn add_is_repeat(&mut self, is_repeat: bool) {
                self.fbb_
                    .push_slot::<bool>(PttDown::VT_IS_REPEAT, is_repeat, false);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> PttDownBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                PttDownBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> PttUp<'a> {
            ...
            pub fn key(&self) -> Option<KeyBinding<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<KeyBinding>>(PttUp::VT_KEY, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PttUpBuilder<'a, 'b, A> {
            ...
            pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<KeyBinding<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<KeyBinding>>(PttUp::VT_KEY, key);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> Status<'a> {
            ...
            pub fn state(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Status::VT_STATE, None)
                }
            }
            #[inline]
            pub fn version(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Status::VT_VERSION, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> StatusBuilder<'a, 'b, A> {
            ...
            pub fn add_state(&mut self, state: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Status::VT_STATE, state);
            }
            #[inline]
            pub fn add_version(&mut self, version: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Status::VT_VERSION, version);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> BindingInfo<'a> {
            ...
            >(
                ...
                builder.add_ts(args.ts);
                if let Some(x) = args.binding {
                    builder.add_binding(x);
                }
                builder.finish()
            }
            ...
            pub fn binding(&self) -> Option<KeyBinding<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<KeyBinding>>(
                        BindingInfo::VT_BINDING,
                        None,
                    )
                }
            }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BindingInfoBuilder<'a, 'b, A> {
            ...
            pub fn add_binding(&mut self, binding: ::flatbuffers::WIPOffset<KeyBinding<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<KeyBinding>>(
                        BindingInfo::VT_BINDING,
                        binding,
                    );
            }
