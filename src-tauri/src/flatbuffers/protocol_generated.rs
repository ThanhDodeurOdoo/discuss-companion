...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_MESSAGE_BODY: u8 = 10;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_MESSAGE_BODY: [MessageBody; 11] = [
  MessageBody::NONE,
  MessageBody::Ping,
  MessageBody::Pong,
  MessageBody::PttDown,
...
impl MessageBody {
  ...
  pub const BindingInfo: Self = Self(7);
  pub const SetBinding: Self = Self(8);
  pub const GetBinding: Self = Self(9);
...
impl<'a> KeyBinding<'a> {
  ...
  #[inline]
  pub fn modifiers(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(KeyBinding::VT_MODIFIERS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for KeyBinding<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("modifiers", Self::VT_MODIFIERS, false)?
     .finish();
    Ok(())
  }
}
pub struct KeyBindingArgs<'a> {
    pub code: u16,
    pub modifiers: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KeyBindingBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_modifiers(&mut self, modifiers: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
