...
declare function props<const Keys extends string[], Defaults extends GetPropsDefaults<KeyedObject<Keys>>>(keys: Keys, defaults: Defaults): Props<WithDefaults<ResolveObjectType<Keys>, GetPropsDefaults<KeyedObject<Keys>>>>;
declare function props<Shape extends {}>(shape: Shape): Props<ResolveObjectType<Shape>>;
declare function props<Shape extends {}, Defaults extends GetPropsDefaults<Shape>>(shape: Shape, defaults: Defaults): Props<WithDefaults<ResolveObjectType<Shape>, GetPropsDefaults<Shape>>>;
...
declare function providePlugins(Plugins: PluginConstructor[], pluginProps?: Object): Plugin[];
...
export { App, Component, EventBus, OwlError, Plugin, PluginManager, Registry, Resource, __info__, assertType, batched, blockDom, computed, effect, htmlEscape, markRaw, markup, mount, onError, onMounted, onPatched, onWillDestroy, onWillPatch, onWillStart, onWillUnmount, onWillUpdateProps, plugin, props, providePlugins, proxy, signal, status, toRaw, types, untrack, useApp, useComponent, useEffect, useListener, useResource, validateType, whenReady, xml };
export type { ComponentConstructor, GetProps, PluginConstructor, ReactiveValue, Signal };
